...
if ($turno_aceptado == 1) {
	...
	switch ($turno_hora) {
		case 1: $horario="10:00 - 10:20";
		case 2: $horario="10:20 - 10:40";
		case 3: $horario="10:40 - 11:00";
		case 4: $horario="11:20 - 11:40"; }
	$datos['Mensaje'] = "Turno Aceptado para el dia ". date("d-m-Y", $turno_fecha) ." en el horario de $horario";
}
